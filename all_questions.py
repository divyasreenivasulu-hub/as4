...
def question8():
    ...
    # float
    answers["(a) P(X_1 = 1 | +)"] = 0.8
    answers["(a) P(X_1 = 1 | -)"] = 0.5
    answers["(a) P(X_2 = 1 | +)"] = 0.5
    answers["(a) P(X_2 = 1 | -)"] = 0.32
    answers["(a) P(X_3 = 1 | +)"] = 0.4
    answers["(a) P(X_3 = 1 | -)"] = 0.16

    # string
    answers["(b) label"] = None

    # float
    answers["(c) P(X_1=1)"] = 0.65
    answers["(c) P(X_2=1)"] =0.41
    answers["(c) P(X_1=1,X_2=1)"] = 0.24
    ...
    answers["(e) P(X_1=1, X_2=1|Class=+)"] = 0.4
    answers["(e) P(X_1=1|Class=+)"] = 0.8
...
def question10():
    ...
    answers["(b) P(R|+)"] = 0.12 #0.24*0.5
    answers["(b) P(R|-)"] = 0.02 # 0.04* 0.5

    # string, '+' or '-'
    answers["(b) class label"] = positive
